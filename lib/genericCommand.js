...
function _buildUsage(cmd) {
  ...
  // This part here relies on _path, I dunno where it comes from
  // It shows up if you run with `turbo`, but not with `mocha`:
  ...
  method: 'post',
  preCmd: [Function],
  _path: 'fh3/admin/environments/alias/create.js',
  _cmdName: 'create',
